    ...
    $('#rzp-button1').click(function (e) { 
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                var options = {
                    "key": "rzp_test_PCJ9PYp4rFSfTh", // Enter the Key ID generated from the Dashboard
                    "amount": response.total_price *100, // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
                    "currency": "INR",
                    "name": "Fruitkha", //your business name
                    "description": "Thak You For Buying From As",
                    "image": "assets/img/favicon.png",
                    "order_id": response.temp, //This is a sample Order ID. Pass the `id` obtained in the response of Step 1
                    "handler": function (responseb){
                        ...
                        data = {
                            ...
                            "total" :response.total_price*100,
                        ...
                        $.ajax({
                            ...
                            success: function (responsec) {
                                ...
                                window.location.href = "/online_sucess/";
